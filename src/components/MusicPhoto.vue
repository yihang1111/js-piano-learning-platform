<template>
    <div class="music-photo" >
        ...
        <div class="music-photo-main">
            <img v-if="!selectedImage" :src="baseUrl + photo_1.imgurl" class="photo-img"  @click="toPhotoDetail"/>
            <img :src="selectedImage" v-if="selectedImage" class="photo-img"  @click="toPhotoDetail"/>
            <div class="photo-like" @click="clickLike" >
                <span class="iconfont icon-xin" :class="{islike:photo_1.islike[0].count > 0}"></span>
