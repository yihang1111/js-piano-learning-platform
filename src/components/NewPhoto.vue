    ...
    <div class="new-photo">
        <div class="photo-main">
            <div class="upload">
                ...
                <!-- 按钮 -->
                <button @click="openFileInput">选择图片</button>
            </div>

            <div class="choose-biaoqian">
                <input type="text" placeholder="选择标签..." class="input">
        ...
        <div class="footbtn" v-show="true">
            <DemoButton button_size="max" button_status="secondary" @click="closeNewCard" class="concel">取消</DemoButton>
