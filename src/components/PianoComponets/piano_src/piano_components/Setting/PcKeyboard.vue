<template>
  <div>
    ...
    <div class="pc-kbd-set" v-show="false">
      <div class="row">
        <span>您可以 </span>
...
export default {
  components: {
    xwButton,
    pcKeyboardSave,
    // 这种懒加载的方式可以提高页面加载速度，因为只有当组件被需要时才会去加载对应的文件，而不是一开始就加载所有组件文件。
    pcKeyboardSaveSys: defineAsyncComponent(() => import('./pc-keyboard-save-sys.vue')),
  },
  data() {
    return {
      kbdMain,
